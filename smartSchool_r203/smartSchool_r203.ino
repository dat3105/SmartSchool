...
JsonObject& root_2 = root[2];
 Status = root_2["status"]; // true
const char* root_2__id = root_2["_id"]; // "5d3f1f091c9d4400001d30f8"
 room= root_2["nameRoom"]; // "LT201"

 light1 = root_2["light"]["light1"]; // false
 light2 = root_2["light"]["light2"]; // false

 fan = root_2["fan"]["fan1"]; // true

 door = root_2["door"]["door1"]; // "false"
